    ...
    while task.wait(1) do
        if _G.StartFarm and _G.MethodSelect == "Farm Bones" then
            pcall(function()        
                ...
                -- Accept quest trước (nếu chưa có quest)
                ...
                if bone then
                    ...
                    until not _G.StartFarm or not bone or not bone.Parent or 
                          (bone.Humanoid and bone.Humanoid.Health <= 0)
                else
                ...
                if bigMirror.Other.Transparency == 0 or enemies:FindFirstChild("Cake Prince") then
                    ...
                    if v then
                        ...
                        until not _G.StartFarm or not v or not v.Parent or 
                              ...
                              bigMirror.Other.Transparency == 0
                    else
                        _tp(CFrame.new(-2077, 252, -12373))
                    end
                end
      ...
      if _G.Raiding then  
        if plr.PlayerGui.Main.TopHUDList.RaidTimer.Visible == true then          
          for i,v in pairs(workspace.Enemies:GetChildren()) do
            if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
              if v.Humanoid.Health > 0 then
                repeat wait() Attack.Kill(v,_G.Raiding) until not _G.Raiding or not v.Parent or v.Humanoid.Health <= 0
                NextIs = true
              end
            end
          end
      ...
      if _G.Prehis_Skills then
        ...
        pcall(function()
          ...
          for i,v in pairs(VolcanoRocks:GetChildren()) do
            ...
            local vfx = v:FindFirstChild("VFXLayer")
            if vfx and vfx:FindFirstChild("At0") and vfx.At0:FindFirstChild("Glow") then
              if vfx.At0.Glow.Enabled == true then
                repeat
                  wait(0.1)
                  if not v.Parent or not vfx.Parent then break end
                  _tp(vfx.CFrame)
                  if plr:DistanceFromCharacter(vfx.CFrame.Position) <= 150 then
                    ...
                    Useskills("Blox Fruit","C") wait(.5)
                  end
                until not _G.Prehis_Skills or not v.Parent or not vfx.Parent or vfx.At0.Glow.Enabled == false
              end
            end
          end
        end)
